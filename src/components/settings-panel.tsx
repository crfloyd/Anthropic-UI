...
export function SettingsPanel({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl h-[600px] max-h-[85vh] flex flex-col">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Automatically trim old messages when approaching
                          context limits
                        </p>
                      </div>
                      <Switch
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Configure when code blocks should be displayed as
                      clickable cards that open in the code canvas instead of
                      inline.
                    </p>
